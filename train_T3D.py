...
params.add_argument("--pre-trained", type=str, default="", help="2d->3d transfer model")
params.add_argument("--t3d_weights", type=str, default='./T3D_saved_model_weights.hdf5', help="2d->3d transfer model")
